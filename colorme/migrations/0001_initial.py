    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_id', models.CharField(max_length=100, verbose_name='商品ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('csv_file', models.FileField(upload_to='item_csv', verbose_name='item csv')),
                ('file_type', models.CharField(choices=[('0', 'product.csv'), ('1', 'optino.csv')], max_length=100)),
                ('record_count', models.IntegerField(verbose_name='登録商品数')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_file', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='colorme.UploadFile', verbose_name='親ファイル')),
            ],
        ),
        migrations.CreateModel(
            name='Option',
            fields=[
                ...
                ('option_2_value', models.CharField(max_length=100)),
                ('option_id', models.CharField(max_length=100)),
                ('kataban', models.CharField(max_length=100)),
                ...
                ('item_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='colorme.Item')),
            ],
        ),
    ]
