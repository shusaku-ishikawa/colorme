    ...
    class RegisterStock:
        ...
        class ChoicesStockVertical:        
            def __init__(self, choices_stock_vertical_element):
                self.choices_stock_vertical_code = choices_stock_vertical_element.find('choicesStockVerticalCode')
                self.choices_stock_vertical_name = choices_stock_vertical_element.find('choicesStockVertialName')
                self.choices_stock_vertical_seq = choices_stock_vertical_element.find('choicesStockVerticalSeq')
        class ChoicesStock:
